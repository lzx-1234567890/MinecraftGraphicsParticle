...
import com.lzx.minecraftparticle.ui.adapter.ParticleCategorySuggestionsAdapter;
...
public class ParticleCategoryDialogFragment extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(getString(R.string.dialog_title_particle_category));
        ...
        searchView.getEditText().setOnEditorActionListener((v, actionId, event) -> {
            viewModel.particleSelected.setValue(searchView.getText().toString());
            dismiss();
            return false;
        });
    ...
    public void onClickSearchSuggestion(String id, String name) {
        viewModel.particleSelected.setValue(id);
        Toast.makeText(getContext(), getString(R.string.has_selected) + "\"" + name + "\"", Toast.LENGTH_SHORT).show();
        dismiss();
    }
    ...
    public void initParticleCategories() {
        ...
        particleCategories.add(new ParticleCategory("minecraft:biome_tinted_leaves_particle", getString(R.string.biome_tinted_leaves_particle)));
        ...
        particleCategories.add(new ParticleCategory("minecraft:firefly_particle", getString(R.string.firefly_particle)));
        ...
        particleCategories.add(new ParticleCategory("minecraft:magic_critical_hit_emitter", getString(R.string.magic_critical_hit_emitter)));
