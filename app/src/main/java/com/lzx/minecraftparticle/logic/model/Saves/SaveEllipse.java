...
import com.lzx.minecraftparticle.ui.fragment.draw.param.regular.DrawEllipseFragment;

import java.util.ArrayList;
import java.util.LinkedHashMap;

public class SaveEllipse extends Save {
    //详细数据
    ...
    private String radiusA, radiusB, reset_radiusA, reset_radiusB;
    ...
    public final String FN = "ellipse";
    ...
    public String getRadiusA() {return radiusA;}
    public String getRadiusB() {return radiusB;}
    ...
    public void setRadiusA(String v) {this.radiusA = v;}
    public void setRadiusB(String v) {this.radiusB = v;}
    ...
    public void reset() {
        ...
        this.radiusA = reset_radiusA;
        this.radiusB = reset_radiusB;
    ...
    public void setReset(){
        ...
        this.reset_radiusA = this.radiusA;
        this.reset_radiusB = this.radiusB;
    ...
    public LinkedHashMap<String, String> getDetailedInformation() {
        ...
        map.put(context.getString(R.string.save_information_ellipse_radiusa), radiusA);
        map.put(context.getString(R.string.save_information_ellipse_radiusb), radiusB);
    ...
    public ERRORCODE check() {
        ...
        if(this.radiusA.isEmpty() || Double.parseDouble(this.radiusA) <= 0) {
            return ERRORCODE.RADIUSA;
        }
        if(this.radiusB.isEmpty() || Double.parseDouble(this.radiusB) <= 0) {
            return ERRORCODE.RADIUSB;
        }
        if(Double.parseDouble(this.radiusA) < Double.parseDouble(this.radiusB)) {
            return ERRORCODE.RADIUSAB;
        }
    ...
    public ArrayList<Vector> getPoints() {
        return DrawUtil.getEllipsePoints(this);
    }

    @Override
    public DrawFragment getDrawFragment() {
        return new DrawEllipseFragment();
    }
}
