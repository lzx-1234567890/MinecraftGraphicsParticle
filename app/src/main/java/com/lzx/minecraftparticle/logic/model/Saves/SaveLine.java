...
import com.lzx.minecraftparticle.ui.fragment.draw.param.line.DrawLineFragment;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.LinkedHashMap;

public class SaveLine extends Save{
    //详细数据
    ...
    public ArrayList<Vector> getPoints() {
        return DrawUtil.getLinePoints(this);
    }
    
    @Override
    public DrawFragment getDrawFragment() {
        return new DrawLineFragment();
    }
