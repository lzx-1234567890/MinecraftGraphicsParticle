...
import com.lzx.minecraftparticle.ui.fragment.draw.param.regular.DrawPolygonFragment;

import java.util.ArrayList;
import java.util.LinkedHashMap;

public class SavePolygon extends Save {
    //详细数据
    ...
    private String sideL, sideN, reset_sideL, reset_sideN;
    ...
    public final String SL = "10", SN = "3";
    ...
    public final String FN = "polygon";
    ...
    public String getSideN() {return sideN;}
    ...
    public void setSideN(String v) {this.sideN = v;}
    ...
    public LinkedHashMap<String, String> getDetailedInformation() {
        ...
        map.put(context.getString(R.string.save_information_regular_side_number), sideN);
    ...
    public ERRORCODE check() {
        ...
        if(this.sideN.isEmpty() || Integer.parseInt(this.sideN) <= 2) {
            return ERRORCODE.SN;
        }
    ...
    public ArrayList<Vector> getPoints() {
        return DrawUtil.getPolygonPoints(this);
    }
