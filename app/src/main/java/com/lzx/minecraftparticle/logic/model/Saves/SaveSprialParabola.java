...
import com.lzx.minecraftparticle.ui.fragment.draw.param.line.DrawSprialParabolaFragment;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.LinkedHashMap;

public class SaveSprialParabola extends Save{
    //详细数据
    ...
    private String angle, angle2, reset_angle, reset_angle2;
    private String radius, reset_radius;
    private String angleV, reset_angleV;
    ...
    public final String ANGLE = "45", ANGLE2 = "0";
    public final String RADIUS = "1";
    public final String ANGLEV = "4";
    ...
    public final String FN = "sprialparabola";


    public SaveSprialParabola() {
        this.type = Type.SPIRALPARABOLA;
    ...
    public String getAngle2() {return angle2;}
    public String getRadius() {return radius;}
    public String getAngleV() {return angleV;}
    ...
    public void setAngle2(String v) {this.angle2 = v;}
    public void setRadius(String v) {this.radius = v;}
    public void setAngleV(String v) {this.angleV = v;}
    ...
    public void reset() {
        ...
        this.angle2 = reset_angle2;
        this.radius = reset_radius;
        this.angleV = reset_angleV;
    ...
    public void setReset(){
        ...
        this.reset_angle2 = this.angle2;
        this.reset_radius = this.radius;
        this.reset_angleV = this.angleV;
    ...
    public LinkedHashMap<String, String> getDetailedInformation() {
        ...
        map.put(context.getString(R.string.save_information_line_angle_rotation), angle2);
        map.put(context.getString(R.string.save_information_helix_radius), radius);
        map.put(context.getString(R.string.save_information_sprialparabola_angle_velocity), angleV);
    ...
    public ERRORCODE check() {
        ...
        if(this.angle2.isEmpty() || Double.parseDouble(this.angle2) > 360 || Double.parseDouble(this.angle2) < 0) {
            return ERRORCODE.ANGLE2;
        }
        if(this.radius.isEmpty() || Double.parseDouble(this.radius) <= 0) {
            return ERRORCODE.RADIUS;
        }
        if(this.angleV.isEmpty()) {
            return ERRORCODE.ANGLEV;
        }
    ...
    public void draw(FragmentActivity fa) {
        if(PermissionUtil.requestStorage(fa)) {
            DrawUtil.drawSprialParabola(this);
        }else {
    ...
    public ArrayList<Vector> getPoints() {
        return DrawUtil.getSprialParabolaPoints(this);
    }
    
    @Override
    public DrawFragment getDrawFragment() {
        return new DrawSprialParabolaFragment();
    }
